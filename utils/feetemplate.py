                ...
                0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px
                  ...
                  border-top: solid 10px green;">
                    ...
                    <tr>
                        ...
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        font-size:13px;">Email</span> {fee_data['email']}</p>
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        font-size:13px;">Phone</span> {fee_data['phone']}</p>
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        font-size:13px;">ID No.</span> {fee_data['accountid']}</p>
                        </td>
                        <td style="width:50%;padding:20px;vertical-align:top">
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        ...
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        font-size:13px;">Class Category</span> {fee_data['classcat']}</p>
                        <p style="margin:0 0 10px 0;padding:0;font-size:14px;">
                        <span style="display:block;font-weight:bold;
                        font-size:13px;">Duration of learning</span>
                        {fee_data['startdate']} to {fee_data['enddate']}</p>
                        </td>
                    </tr>
                    <tr>
